...
* 📊 **AI 예측 결과 기반**의 절약 챌린지를 UI에서 직관적으로 확인 및 관리
* 🎯 카테고리별 소비 현황과 예산 초과 여부를 한눈에 보여주는 **주간 소비 리포트**
* 💬 \*\*GPT-4o-mini 기반 챗봇 '똑똑소비봇'\*\*과 실시간 소비 상담
* 🧩 절약 성공 시 **캐릭터 해금, 배경 변화 등 게이미피케이션 요소로 동기 부여**

**Mooney Frontend**는 이러한 기능을 유저가 손쉽게 이용할 수 있도록 Flutter를 통해 빠르고 안정적으로 구현되었습니다.
